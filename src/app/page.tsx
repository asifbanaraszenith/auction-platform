    ...
    <main className="home-shell">
      ...
      <section className="hero-section">
        <div className="hero-content-stack">
          <div className="hero-copy"><p className="section-kicker">Auction Platform</p><h1>Configurable auction<br className="desktop-break" /> platform for leagues</h1><span className="gold-rule" aria-hidden="true" /><p className="hero-description">Enterprise auction management for leagues, participants, teams, and live auction workflows.</p></div>
