  ...
  if (name === "people") {
    return (
      <svg viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path d="M13 36c0-6 4.8-10 11-10s11 4 11 10" />
        <path d="M10 27c-3.5.8-6 3.5-6 7m34-7c3.5.8 6 3.5 6 7" />
        <path d="M9 18a5 5 0 1 0 0 10m30-10a5 5 0 1 1 0 10" />
      </svg>
    );
  }
  if (name === "shield") {
  ...
  if (name === "document") {
    return (
      <svg viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path d="M30 5v9h8M17 21h15M17 27h15M17 33h8" />
        <circle cx="34" cy="34" r="7" />
        <path d="M31 34l2 2 4-5" />
      </svg>
    );
  }
  return (
    <svg viewBox="0 0 48 48" aria-hidden="true">
      ...
      <path d="M16 8l-4 4 24 24 4-4z" />
      <path d="M8 40h32M14 35h20" />
    </svg>
  );
}
