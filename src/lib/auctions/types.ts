...
export type Player = { id: string; displayName: string; email?: string; photoUrl?: string; auctions?: { auctionId: string; auctionName: string }[]; createdBy: string; createdAt: Timestamp; updatedAt: Timestamp };
...
export type AuctionBidder = { id: string; userId: string; displayName: string; teamId?: string | null; initialPurse: number; spentPurse?: number; status: "active" | "inactive"; createdAt: Timestamp; updatedAt: Timestamp };
export type AuctionTeam = { id: string; name: string; bidderId?: string | null; initialPurse: number; spentPurse: number; minSquadSize: number; maxSquadSize: number; active: boolean; createdAt: Timestamp; updatedAt: Timestamp };
...
export type AuctionAuditLog = { id: string; actorId: string; actorName?: string; action: string; entityType: string; entityId?: string; details?: Record<string, unknown>; createdAt: Timestamp };
